class AddKeys < ActiveRecord::Migration
  def change
    ...
    add_foreign_key "hosts", "source_files", :name => "hosts_source_file_id_fk"
    ...
    add_foreign_key "param_values", "param_names", :name => "param_values_param_name_id_fk"
    add_foreign_key "param_values", "resources", :name => "param_values_resource_id_fk"
    add_foreign_key "reports", "hosts", :name => "reports_host_id_fk"
    add_foreign_key "resource_tags", "puppet_tags", :name => "resource_tags_puppet_tag_id_fk"
    add_foreign_key "resource_tags", "resources", :name => "resource_tags_resource_id_fk"
    add_foreign_key "resources", "hosts", :name => "resources_host_id_fk"
    add_foreign_key "resources", "source_files", :name => "resources_source_file_id_fk"
