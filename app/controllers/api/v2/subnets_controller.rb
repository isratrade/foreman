module Api
  module V2
    class SubnetsController < V2::BaseController
      ...
      api :GET, "/locations/:location_id/subnets", N_("List of domains per location")
      api :GET, "/organizations/:organization_id/subnets", N_("List of domains per organization")
