...
install -Dp -m0644 foreman.logrotate %{buildroot}%{_sysconfdir}/logrotate.d/%{name}
install -Dp -m0644 foreman.cron.d %{buildroot}%{_sysconfdir}/cron.d/%{name}
%if 0%{?rhel} > 6 || 0%{?fedora} > 16
install -Dp -m0644 foreman.tmpfiles %{buildroot}%{_prefix}/lib/tmpfiles.d/%{name}.conf
%endif
...
- Fixes #10826 - Adds unique constraint to the title in operatingsystem table
  (oprazak@redhat.com)
- 1246227 - remove welcome landing page in favor of the Dashboard
  (mmccune@redhat.com)
...
* Tue Jun 30 2015 dlobatog <elobatocs@gmail.com> 1.7.2.29-1
1128725, 1234549, 1236492
* Tue Jun 23 2015 dlobatog <elobatocs@gmail.com> 1.7.2.28-1
Fixes for #5018, 1233084, 1226012, 1226282
...
* Thu Feb 05 2015 Jason Montleon <jmontleo@redhat.com> 1.7.2.3-1
- Fixes BZ#1186321 - Add kickstart networking setup snippet (mhulan@redhat.com)
