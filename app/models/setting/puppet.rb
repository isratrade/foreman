  ...
  def self.load_defaults
    ...
    self.transaction do
      [
        ...
        self.set('remove_classes_not_in_environment', N_("Remove classes from environments different to the host's environment when a host and its host group have different environments"), true),
